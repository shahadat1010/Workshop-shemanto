"""
 Define the countNum function:
    ...
    Iterate over the range from start to end .
      ...
      Check if the string representation of num is contained within the string representation of the current number.
 ...
 Define a list of test cases, each containing:
    start, end, num: Input parameters for the countNum function.
    expected_output: The expected output of the function for the given input.

 For each test case:
    Extract input parameters and expected output.
    Call `countNum` with the input parameters and store the result.
    Print details of the test case, including input values, expected output, and actual output.
    Check if the actual output matches the expected output:
      If matched, print "Test Result: Passed".
      If not matched, print "Test Result: Failed".
